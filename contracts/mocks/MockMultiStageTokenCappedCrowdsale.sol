...
contract MockMultiStageTokenCappedCrowdsale is TokenCappedCrowdsale {
    ...
    function MockMultiStageTokenCappedCrowdsale(uint256 _startTime, uint256[] _ends, uint256[] _swapRate, address _wallet,  address _token, uint256[] _capTimes, uint256[] _cap) public
    ...
    function listCaps() public view returns (uint256[] ends, uint256[] caps) {
